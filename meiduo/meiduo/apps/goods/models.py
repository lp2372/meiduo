...
class Goods(BaseModel):
    ...
    商品SPU
    """
    name = models.CharField(max_length=50, verbose_name='名称')  # verbose_name admin站点显示的字段名
    ...
    # ckeditor.fields.RichTextField不支持上传文件的富文本字段
    # ckeditor_uploader.fields.RichTextUploadingField支持上传文件的富文本字段
    ...
    class Meta:
        db_table = 'tb_goods' #数据库表名
        verbose_name = '商品' # admin站点中显示的表名
        verbose_name_plural = verbose_name
